...
import postgres from "../assets/technologyStack/psql.png";
...
export default function SectionTechnologyStack() {
  ...
  return (
    <section
      ref={ref}
      className={`my-[12px] min-h-screen gap-y-20 pt-8 w-full flex flex-col justify-center items-center relative`}
    >
      <div className="text-center">
        ...
        >
          I am committed to delivering exceptional results for my client. That's
          why I continuously update and use the best technologies, ensuring not
          only optimal performance but also beautiful design, intuitive user
          experience, and robust functionality in my products.
        </motion.p>
      </div>
      ...
      <div
        className="absolute bottom-0 inset-0 z-20 flex justify-center 
