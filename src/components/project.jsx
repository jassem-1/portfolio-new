    ...
    <div>
      ...
      >
        <section className="bg-[#0b0e13] max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[18rem] transition sm:group-even:pl-8 dark:bg-white/10 dark:hover:bg-white/20">
          ...
          <div className="pt-4 pb-4 px-5 sm:pl-6 sm:pr-2 sm:pt-10 sm:max-w-[60%] flex flex-col h-full sm:group-even:ml-[18rem]">
            <div className="flex justify-between w-full">
              <h3 className="text-base xs:text-2xl text-white font-semibold">
                {title}
              </h3>
              <div className="sm:hidden px-1 rounded-xl h-6 border-white border py-1">
                <IoMdEye className="text-white" />
              </div>
            </div>
